...
![Version](https://img.shields.io/badge/版本-2.3.0-brightgreen) ![Tests](https://img.shields.io/badge/测试-1135%2B-blue) ![License](https://img.shields.io/badge/License-MIT-orange) ![Platform](https://img.shields.io/badge/Windows%20%2F%20WEB%20%2F%20Android-✓-lightgrey)
...
| 📊 **工程级质量** | 26 个后端模块、120+ API、**1135+ 自动化测试**全绿、TypeScript 严格模式 |
...
| 安装包 | `dist_electron/Aether Setup 2.3.0.exe` | 一键安装，桌面/开始菜单快捷方式 |
...
**质量基线：1135+ 自动化测试全绿**（backend 1135 + shared 32 + frontend 62 + mobile 25）+ TypeScript 严格模式 + ESLint。
...
│   │       ├── db/      # Drizzle schema + sql.js 迁移（v1-v15）
